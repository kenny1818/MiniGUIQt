...
CLASS HMGComboBox INHERIT HMGWidget
...
METHOD new (cName,cParent,nX,nY,nWidth,nHeight,cToolTip,cStatusTip,cWhatsThis,cStyleSheet,;
            ...
            aItems,lInvisible,lDisabled,lNoTabStop,bOnGotFocus,bOnLostFocus) CLASS HMGComboBox
   ...
   ELSE
      ::oQt := QComboBox():new(HMGFILO():last():oQt)
